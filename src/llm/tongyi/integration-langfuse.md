...
* 装饰 `langfuse.callback.langchain._parse_usage` 函数。我用这种方式实现（实现已经放到 github [langfarm-python-sdk](https://github.com/langfarm/langfarm-python-sdk)，已经发布到 PyPI），使用时更方便。
